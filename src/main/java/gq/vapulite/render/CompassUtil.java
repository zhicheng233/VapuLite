...
import gq.vapulite.math.Degree;
...
public class CompassUtil {
	...
	public void draw(ScaledResolution sr) {
		...
		GL11.glPushMatrix();
		GL11.glEnable(3089);
		RenderUtil.doGlScissor(sr.getScaledWidth() / 2 - 120, 25, 220, 25);
		for (Degree d : degrees) {
			...
			if (d.type == 2 && opacity != 16777215) {
				GlStateManager.color(1, 1, 1, 1);
				RenderUtil.drawRect(location - 0.5f, -75 + 100 + 4, location + 0.5f, -75 + 105 + 4,
